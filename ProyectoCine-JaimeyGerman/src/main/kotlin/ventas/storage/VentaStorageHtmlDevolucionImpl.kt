package dev.jaimeleon.ventas.storage

import com.github.michaelbull.result.Err
import com.github.michaelbull.result.Ok
import com.github.michaelbull.result.Result
import dev.jaimeleon.locale.toDefaultDateString
import dev.jaimeleon.locale.toDefaultMoneyString
...
/**
 * Clase para realizar la exportacion de una devolucion a un archivo html
 * @author German
 * @since 1.0.0
 */
class VentaStorageHtmlDevolucionImpl {
    /**
    ...
    fun export(venta: Venta, file: File): Result<Unit, VentaError> {
        ...
        return try {
            ...
            <html>
                <head>
                    <title>Fichero de Devolución</title>
                    <meta charset="utf-8">
                ...
                <body>
                    <div class="container">
                        <h1><span style="text-decoration: underline; color: #3366ff;">Ticket de devolución Cines DAWFILMS</span> 🍿🎥</h1>
                        <ul>
                        ...
                        <ul>
                            <li style="font-size: larger;"><strong>Devolución Total: </strong>${venta.total.toDefaultMoneyString()}<br /><br /></li>
                        </ul>
                        ...
                        <p class="text-right lead" style="text-align: center;"><span style="font-weight: bold;">&iexcl; GRACIAS POR SU DEVOLUCIÓN !<br />👋🏻👋🏻👋🏻</span></p>
                    </div>
                </body>
            </html>
        """.trimIndent()
